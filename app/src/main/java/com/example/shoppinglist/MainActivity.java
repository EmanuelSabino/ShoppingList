...
import com.example.shoppinglist.ui.List.EditList.EditList;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_home,R.id.nav_utgent_list, R.id.nav_all_list, R.id.nav_all_categories, R.id.nav_edit_list,
                R.id.nav_final_price)
        ...
        if(sql.oneUser() == null){
            startActivity(new Intent(this, welcome01layout.class));
        }
